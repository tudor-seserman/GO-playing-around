...
func main() {
	...
	fmt.Println("Please enter a word, phrase or sentence.")
	userInput, _ := reader.ReadString('\n')

	if strings.Index(userInput, "i") == 0 && strings.Contains(userInput, "a") && strings.LastIndex(userInput, "n") == len(userInput)-2 {
		fmt.Println("Found!")
	} else {
